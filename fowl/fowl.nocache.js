function fowl(){var X='',eb='" for "gwt:onLoadErrorFn"',cb='" for "gwt:onPropertyErrorFn"',fb='#',rb='.cache.js',hb='/',qb=':',Y='::',L='<html><head><\/head><body><\/body><\/html>',_='=',gb='?',pb='DB3B6B33A92DD0E778B2C47EA7C9777D',bb='Bad handler "',Q='DOMContentLoaded',G='DUMMY',mb='base',kb='baseUrl',B='begin',H='body',A='bootstrap',jb='clear.cache.gif',$='content',tb='end',E='fowl',ob='fowl.devmode.js',lb='fowl.nocache.js',W='fowl::',C='gwt.codesvr.fowl=',D='gwt.codesvr=',db='gwt:onLoadErrorFn',ab='gwt:onPropertyErrorFn',Z='gwt:property',T='head',I='iframe',ib='img',N='javascript',J='javascript:""',sb='loadExternalRefs',U='meta',S='moduleRequested',R='moduleStartup',V='name',K='position:absolute; width:0; height:0; border:none; left: -1000px; top: -1000px; !important',M='script',nb='selectingPermutation',F='startup',P='undefined',O='var $wnd = window.parent;';var n=window;var o=document;q(A,B);function p(){var a=n.location.search;return a.indexOf(C)!=-1||a.indexOf(D)!=-1}
